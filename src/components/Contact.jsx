    ...
    return (
        <section id="contact" ref={sectionRef} className="relative py-24 px-4">
            <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="scroll-hidden text-white font-medium mb-14 mx-auto text-xl md:text-2xl" style={{ transitionDelay: '0.05s' }}>
                ...
                <div className="grid sm:grid-cols-3 gap-6 mb-14">
                    ...
                    >
                        ...
                        <div>
                            <p className="text-primary-300 font-bold text-base mb-1">โทรศัพท์</p>
                    ...
                    >
                        ...
                        <div>
                            <p className="text-primary-300 font-bold text-base mb-1">Facebook</p>
                    ...
                    >
                        <div className="w-[4.5rem] h-[4.5rem] rounded-full bg-gradient-to-br from-[#00B900] to-[#009900] flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-green-400/20">
                            <img src={lineLogo} alt="LINE" className="w-10 h-10 text-white fill-current" />
                        </div>
                        <div>
                            <p className="text-primary-300 font-bold text-base mb-1">LINE ID</p>
                ...
                <div className="scroll-hidden glass-card rounded-3xl p-10 md:p-14" style={{ transitionDelay: '0.5s' }}>
                    ...
                    <p className="text-white font-medium mb-8 max-w-md mx-auto text-xl md:text-2xl leading-relaxed">
                        ติดต่อแม่หมอปุ้มได้เลยวันนี้ พร้อมให้คำปรึกษาทุกเรื่องราว ด้วยไพ่พรหมญาณที่แม่นยำ
                    </p>
                    
                    {/* QR Code Section for Desktop */}
                    <div className="hidden md:flex flex-col items-center mb-10 bg-white/5 p-6 rounded-2xl border border-white/10 max-w-xs mx-auto">
                        <div className="w-40 h-40 bg-white rounded-xl p-2 mb-3">
                             {/* Placeholder for QR Code - User can replace with actual QR image */}
                             <img 
                                src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://line.me/ti/p/~friendandpum" 
                                alt="QR Code LINE" 
                                className="w-full h-full"
                             />
                        </div>
                        <p className="text-gold-200 font-bold text-lg">สแกนเพิ่มเพื่อนทันที</p>
                    </div>
                    <div className="flex flex-col sm:flex-row gap-5 justify-center">
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="btn-line px-10 py-5 rounded-full text-white font-bold text-xl flex items-center justify-center gap-3 hover:scale-105 transition-transform"
                        >
                            <img src={lineLogo} alt="LINE" className="w-8 h-8" />
                            LINE
                        </a>
                    </div>
                </div>
